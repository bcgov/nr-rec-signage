...
const SignConfiguration: React.FC = () => {
  ...
  const renderPreview = () => {
    ...
    return renderSignMarkup(signDetails, fields, metadata,false);
  };
  ...
  return (
    <div className='centered-l-container d-flex gx-120 '>
      ...
      <div style={{width: '560px',zIndex: 1}}>
        <div  className="d-flex preview-window flex-column align-items-center ">
