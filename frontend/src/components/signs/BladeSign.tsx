...
const BladeSign: React.FC<BladeSignProps> = ({ fields, metadata, isRealSize }) => {
  ...
  return (
    <div ref={bannerRef} className="blade-sign w-100 d-flex flex-column align-items-center justify-content-center">
        <div className='exportable'  style={{aspectRatio: `48 / 5.5`,width: `${inch * 48}px`, backgroundColor: '#4E3629', borderRadius: `${inch * 0.5}px`,
        ...
        <div className='exportable' style={{height: `${inch * 9}px`,width: `${inch * 36}px`, backgroundColor: '#4E3629', borderRadius: `${inch * 0.5}px`,
