...
DELETE from sign_value where id_sign in (select id from "Sign" where id_category=7);
DELETE from "Sign" where id_category=7;
DELETE from sign_field where id_category=7;
DELETE from sign_category where id=7;
